...
This is an English translation provided for convenience. The Hebrew version at [scayla.co.il/terms](/terms) is the legally binding text under Israeli law.
...
8.4. **Currency, VAT and invoicing.** Prices shown on the site are denominated in US dollars (USD) and **include value added tax**. The price you see is the final amount you are charged; no taxes or other additions are applied at billing. The VAT component is itemised separately on the invoice at the rate in force on the date of the charge. A lawful invoice is issued for every charge and sent to the email address you provided, no later than 14 days from the date of the charge. **By signing up you consent to receiving these documents (invoice, receipt and credit note) electronically by email rather than as a printed copy.** You may withdraw that consent at any time by contacting us, and we will then deliver the documents by other means. A credit card charge may appear in shekels at your card issuer's conversion rate; we are not party to that rate or to any conversion fees the issuer charges.
...
## 16. Accessibility
16.1. We work to make the service accessible in accordance with the Israeli Equal Rights for Persons with Disabilities (Service Accessibility Adjustments) Regulations, 2013. Accessibility coordinator: Lior Zabari · lior+scayla@mrmake.co.il. The full accessibility statement is available on the accessibility page.

## 17. Disputes and first contact
17.1. For any complaint or dispute we ask that you contact us first at lior+scayla@mrmake.co.il, and we will endeavour to resolve it within a reasonable time. This does not derogate from your right to approach any competent authority or the courts.
